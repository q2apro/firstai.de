...
public class ErsteHilfe3 extends MIDlet implements CommandListener {
	...
	public void applyText(int auswahl) {
		...
		if (auswahl==10) globalchoice = 6;   // beatmung -> atemstillstand
		else if (auswahl==28) globalchoice = 58; // herzdruckmassage -> wiederbelebung
		else if (auswahl==35) globalchoice = 58; // reanimation -> wiederbelebung
		else if (auswahl==36) globalchoice = 59; // rückenverletzung
		else if (auswahl==46) globalchoice = 30; // überhitzung 
		else if (auswahl==47) globalchoice = 15; // überzuckerung
		else if (auswahl==48) globalchoice = 55; // verkehrsunfall -> unfallstelle
		else if (auswahl==56) globalchoice = 23; // verschlucken
...
/* AUDIO: http://forums.sun.com/thread.jspa?threadID=533379
