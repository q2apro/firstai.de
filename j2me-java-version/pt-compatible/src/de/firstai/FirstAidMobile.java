...
public class FirstAidMobile extends MIDlet implements CommandListener {
	...
	public void applyText(int auswahl) {
		...
		// APPLYING TEXT
		if (auswahl == 0) { details.append(aid_disclaimer); }
		else if (auswahl == 2) { details.append(aid_general); }
		else if (auswahl == 3) { details.append(aid_resuscitation); }
		else if (auswahl == 4) { details.append(aid_diabeticcoma); }
		else if (auswahl == 5) { details.append(aid_hypoglycaemia); }
		else if (auswahl == 6) { details.append(aid_hypothermia); }
		else if (auswahl == 7) { details.append(aid_electricityaccident); }
		else if (auswahl == 8) { details.append(aid_safeguardaccident); }
		else if (auswahl == 9) { details.append(aid_snakebite); }
		else if (auswahl == 10) { details.append(aid_drowning); }
		else if (auswahl == 11) { details.append(aid_amputation); }
		else if (auswahl == 12) { details.append(aid_apnoea); }
		else if (auswahl == 13) { details.append(aid_suffocation); }
		else if (auswahl == 14) { details.append(aid_asthma); }
		else if (auswahl == 15) { details.append(aid_heartattack); }
		else if (auswahl == 16) { details.append(aid_stroke); }
		else if (auswahl == 17) { details.append(aid_checkbreathing); }
		else if (auswahl == 18) { details.append(aid_shock); }
		else if (auswahl == 19) { details.append(aid_diabeticcoma); }
		else if (auswahl == 20) { details.append(aid_brainconcussion); }
		else if (auswahl == 21) { details.append(aid_diarrhoea); }
		else if (auswahl == 22) { details.append(aid_asthma); }
		else if (auswahl == 23) { details.append(aid_suffocation); }
		else if (auswahl == 24) { details.append(aid_poisining); }
		else if (auswahl == 25) { details.append(aid_epilepsy); }
		else if (auswahl == 26) { details.append(aid_sprain); }
		else if (auswahl == 27) { details.append(aid_fracture); }
		else if (auswahl == 28) { details.append(aid_skullfracture); }
		else if (auswahl == 29) { details.append(aid_backinjury); }
		else if (auswahl == 30) { details.append(aid_hyperthermia); }
		else if (auswahl == 31) { details.append(aid_unconsciouswithbreath); }
		else if (auswahl == 32) { details.append(aid_unconsciouswithoutbreath); }
		else if (auswahl == 33) { details.append(aid_sunstroke); }
		else if (auswahl == 34) { details.append(aid_backinjury); }
		else if (auswahl == 35) { details.append(aid_eyeinjury); }
		else if (auswahl == 36) { details.append(aid_emergencycall); }
		else if (auswahl == 37) { details.append(aid_animalbite); }
		else if (auswahl == 38) { details.append(aid_birth); }
		else if (auswahl == 39) { details.append(aid_insectstings); }
		else if (auswahl == 40) { details.append(aid_recoveryposition); }
		else if (auswahl == 41) { details.append(aid_frostbitesevere); }
		else if (auswahl == 42) { details.append(aid_frostbitemild); }
		else if (auswahl == 43) { details.append(aid_chemicalburn); }
		else if (auswahl == 44) { details.append(aid_chemicalburneyes); }
		else if (auswahl == 45) { details.append(aid_sunburn); }
		else if (auswahl == 46) { details.append(aid_burningsevere); }
		else if (auswahl == 47) { details.append(aid_burningslight); }
		else if (auswahl == 48) { details.append(aid_allergic); }
		else if (auswahl == 49) { details.append(aid_resuscitation); }
		else if (auswahl == 50) { details.append(aid_icerescue); }
		else if (auswahl == 51) { details.append(aid_apnoea); }
		else if (auswahl == 52) { details.append(aid_bleedingsevere); }
		else if (auswahl == 53) { details.append(aid_bleedinglight); }
		else if (auswahl == 54) { details.append(aid_nosebleeding); }
		else if (auswahl == 55) { details.append(aid_safeguardaccident); }
		else if (auswahl == 56) { details.append(aid_sos); }
		else if (auswahl == 57) { details.append(aid_vomiting); }
		else if (auswahl == 58) { details.append(aid_dangerzone); }
	}
