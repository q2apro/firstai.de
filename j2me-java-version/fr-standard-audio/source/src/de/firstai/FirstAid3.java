...
public class FirstAid3 extends MIDlet implements CommandListener {
	...
	public FirstAid3() {
		...
		this.menu.append("# Responsabilité + Info", null); // 0
		this.menu.append("# Appels d'urgence", null);
		this.menu.append("# Conduite générale", null); // 1
		this.menu.append("Allergie", null); // 2
		// this.menu.append("Accident de la circulation", null);
		this.menu.append("Accident de voiture", null); // 38
		this.menu.append("Accouchement", null); // 8
		this.menu.append("Amputation", null); // 3
		this.menu.append("Appelez les services d'urgence", null); // 4
		this.menu.append("Arrêt respiratoire", null); // 5
		this.menu.append("Asthme", null); // 6
		this.menu.append("Brûlure chimique", null); // 16
		this.menu.append("Brûlure chimique (yeux)", null); // 15
		this.menu.append("Brûlure grave", null); // 13
		this.menu.append("Brûlure légère", null); // 12
		this.menu.append("Brûlure par le froid - grave", null); // 27
		this.menu.append("Brûlure par le froid - léger", null); // 26
		this.menu.append("Choc (Hémorragies)", null); // 39
		this.menu.append("Coma diabétique", null); // 18
		this.menu.append("Commotion cérébrale", null); // 11
		this.menu.append("Compression du thorax", null); // .......... 
		this.menu.append("Coup de soleil", null); // 46
		this.menu.append("Crise Cardiaque", null); // 28
		this.menu.append("Dégagement d'urgence", null); // 17
		this.menu.append("Diarrhées", null); // 19
		this.menu.append("Dos - Blessure", null); // 7
		this.menu.append("Électrocution", null); // 21
		this.menu.append("Entorse", null); // 43
		this.menu.append("Épilepsie", null); // 23
		this.menu.append("Essoufflement", null); // ............
		this.menu.append("Etouffement/Étranglement", null); // 45
		// this.menu.append("Étranglement", null);
		this.menu.append("Fracture", null); // 25
		this.menu.append("Fracture du crâne", null); // 40
		this.menu.append("Fracture du dos", null); // ...........
		this.menu.append("Hyperglycémie (forte teneur en sucre)", null); // ........... 
		this.menu.append("Hyperthermie (corps trop chaud)", null); // 30
		this.menu.append("Hypoglycémie (faible teneur en sucre)", null); // 29 
		this.menu.append("Hypothermie (corps trop froid)", null); // 31
		this.menu.append("Inconscient avec respiration", null); // 48
		this.menu.append("Inconscient sans respiration", null); // 49
		this.menu.append("Insolation", null); // 47
		this.menu.append("Intoxication", null); // 35
		this.menu.append("Morsures d'animaux", null); // 4 
		this.menu.append("Nez - saignement", null); // 34
		this.menu.append("Noyade", null); // 20
		this.menu.append("Oeil - blessures", null); // 24 
		this.menu.append("Piqûres d'insectes", null); // 33
		this.menu.append("Position latérale de sécurité", null); // 36 
		this.menu.append("Réanimation", null); // 37
		// this.menu.append("Réanimation", null);
		this.menu.append("Respiration", null); // .............
		this.menu.append("Saignement grave", null); // 10
		this.menu.append("Saignement léger", null); // 9
		this.menu.append("Sauvetage sur glace", null); // 32
		this.menu.append("Serpent - Morsures", null); // 41
		this.menu.append("SOS", null); // 42
		this.menu.append("Vérifiez la respiration", null); // 14
		this.menu.append("Vertige", null); // 44
		this.menu.append("Vomissements", null); // 50
	...
	public void applyText(int auswahl) {
		...
		// Respiration -> Arrêt respiratoire
		// Essoufflement -> Asthme
		// Compression du thorax -> Réanimation
		// Hyperglycémie -> coma diabétique
		// Fracture du dos -> Dos - Blessure
		// Étranglement -> Etouffement
		// Accident de la circulation -> Dégagement d'urgence
		// END
		// relations menu item-nr to mp3-nr
		if (auswahl==2) mp3nr = 1;
		else if (auswahl==3) mp3nr = 2;
		else if (auswahl==4) mp3nr = 38;
		else if (auswahl==5) mp3nr = 8;
		else if (auswahl==6) mp3nr = 3;
		else if (auswahl==7) mp3nr = 22;
		else if (auswahl==8) mp3nr = 5;
		else if (auswahl==9) mp3nr = 6;
		else if (auswahl==10) mp3nr = 16;
		else if (auswahl==11) mp3nr = 15;
		else if (auswahl==12) mp3nr = 13;
		else if (auswahl==13) mp3nr = 12;
		else if (auswahl==14) mp3nr = 27;
		else if (auswahl==15) mp3nr = 26;
		else if (auswahl==16) mp3nr = 39;
		else if (auswahl==17) mp3nr = 18;
		else if (auswahl==18) mp3nr = 11;
		else if (auswahl==19) mp3nr = 37;
		else if (auswahl==20) mp3nr = 46;
		else if (auswahl==21) mp3nr = 28;
		else if (auswahl==22) mp3nr = 17;
		else if (auswahl==23) mp3nr = 19;
		else if (auswahl==24) mp3nr = 7;
		else if (auswahl==25) mp3nr = 21;
		else if (auswahl==26) mp3nr = 43;
		else if (auswahl==27) mp3nr = 23;
		else if (auswahl==28) mp3nr = 6;
		else if (auswahl==29) mp3nr = 45;
		else if (auswahl==30) mp3nr = 25;
		else if (auswahl==31) mp3nr = 40;
		else if (auswahl==32) mp3nr = 7;
		else if (auswahl==33) mp3nr = 18;
		else if (auswahl==34) mp3nr = 30;
		else if (auswahl==35) mp3nr = 29;
		else if (auswahl==36) mp3nr = 31;
		else if (auswahl==37) mp3nr = 48;
		else if (auswahl==38) mp3nr = 49;
		else if (auswahl==39) mp3nr = 47;
		else if (auswahl==40) mp3nr = 35;
		else if (auswahl==41) mp3nr = 4;
		else if (auswahl==42) mp3nr = 34;
		else if (auswahl==43) mp3nr = 20;
		else if (auswahl==44) mp3nr = 24;
		else if (auswahl==45) mp3nr = 33;
		else if (auswahl==46) mp3nr = 36;
		else if (auswahl==47) mp3nr = 37;
		else if (auswahl==48) mp3nr = 5;
		else if (auswahl==49) mp3nr = 10;
		else if (auswahl==50) mp3nr = 9;
		else if (auswahl==51) mp3nr = 32;
		else if (auswahl==52) mp3nr = 41;
		else if (auswahl==53) mp3nr = 42;
		else if (auswahl==54) mp3nr = 14;
		else if (auswahl==55) mp3nr = 44;
		else if (auswahl==56) mp3nr = 50;
